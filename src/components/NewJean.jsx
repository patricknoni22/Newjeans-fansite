...
export default function NewJean() {
      ...
      return (
            <>
                  ...
                  <header>
                        ...
                        <nav className="desk">
                              <span>
                                    <a href="https://www.instagram.com/newjeans_official/" target="_blank" rel="noopener noreferrer">Instagram</a>
                              </span>
                              <span>
                                    <a href="https://www.tiktok.com/@newjeans_official" target="_blank" rel="noopener noreferrer"> TikTok </a>
                              </span>

                              <span>
                                    <a href="https://www.facebook.com/official.newjeans" target="_blank">facebook</a>
                              </span>
                              <span>
                                    <a href="https://www.youtube.com/@NewJeans_official" target="_blank" rel="noopener noreferrer">Youtube</a>
                              </span>
                        ...
                        <section>
                              ...
                              <div className="sec2">
                                    ...
                                    <div className="sec2-txt">
                                          <p>Hanni Pham (born October 6, 2004) is a Vietnamese-Australian singer, dancer, and member of the K-pop girl group NewJeans under ADOR. Born in Melbourne, Australia, she debuted with the group in July 2022 and is known for her vibrant vocals and performances. She is a key member of the five-piece group known for hits like "Hype Boy" and "Ditto</p>
                              ...
                              <div className="sec2">
                                    ...
                                    <div className="sec2-txt">
                                          <p>Danielle Marsh (born 2005) is an Australian-Korean singer and member of the K-pop group NewJeans. Known for her work in the group and as a, she continues a solo career while pursuing independent activities</p>
                              ...
                              <div className="sec2">
                                    ...
                                    <div className="sec2-txt">
                                          <p>Kim Min-ji (Korean: 김민지; born May 7, 2004), known mononymously as Minji,  debuted as a member of the South Korean girl group NewJeans. Minji gained immense popularity after her debut, ranking first in the girl group solo brand rankings for three consecutive months </p>
                              ...
                              <div className="sec2">
                                    ...
                                    <div className="sec2-txt">
                                          <p>Haerin (Kang Hae-rin) is a South Korean singer and member of the girl group NewJeans, born on May 15, 2006, in Seoul. Known for her cat-like visuals, calm personality, and sharp stage presence, she debuted under ADOR on July 22, 2022, and serves as a global ambassador for Dior </p>
                              ...
                              <div className="sec2">
                                    ...
                                    <div className="sec2-txt">
                                          <p>Hyein (Lee Hye-in) is the youngest member (maknae) of the K-pop girl group NewJeans, born on April 21, 2008. She debuted with the group on July 22, 2022, under ADOR, and is known for her prior experience as a child model and member of children's groups U.SSO Girl and Play With Me Club. She is a global ambassador for Louis Vuitton. </p>
